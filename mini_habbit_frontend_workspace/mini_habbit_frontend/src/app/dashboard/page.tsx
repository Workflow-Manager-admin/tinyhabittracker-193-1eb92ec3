...
export default async function DashboardPage() {
  ...
  // Client-side auth guard for navigation session-loss case (prevents flash of content after token expire/logout)
  return (
    // Use dynamic import to only include AuthGuard on client
    <div suppressHydrationWarning>
      {typeof window === "undefined" ? (
        // SSR fallback, just show dashboard shell for SSR pass
        <div className="min-h-screen flex h-screen bg-gray-50 dark:bg-zinc-900"></div>
      ) : (
